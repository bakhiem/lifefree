...
export default {
  ...
  data: () => ({
    ...
    editorConfig: {
        ...
        toolbar: ['heading', '|', 'fontfamily', 'fontsize', 'fontColor', 'fontBackgroundColor', '|', 'insertTable', '|', 'bold', 'italic', 'link', 'bulletedList', 'numberedList', '|', 'alignment', '|', 'indent', 'outdent', '|', 'imageInsert', 'blockQuote', 'mediaEmbed'],
        heading: {
          options: [
